        ...
        <FormGrid onSubmit={enviarDados}>
          ...
          <div style={{ width: "155%", height: "75%" }}>
            ...
            <div style={{ width: "100%", height: "80%" }}>
              ...
              >
                <InputPadrao style={{ marginTop: "1.5rem" }}>
                  <label>Nome *: </label>
                  <input
                ...
                <InputMenorPadrao>
                  ...
                  <input
                    onInput={(evento) => {
                      setNascimentoInput(evento.target.value);
                    }}
                    name="nascimento"
                    type="date"
              ...
              >
                <InputPadrao>
                  ...
                  {inputPassordErr && (
                    <p>
                      *Sua senha deve conter numero, caracter e letra maiscula
                    </p>
                  )}
                </InputPadrao>
                <InputPadrao>
            ...
            >
              <BtnPadrao onClick={validate}> REGISTRAR CONTA</BtnPadrao>
              <p>
                Tem uma ong?{" "}
                <Link to="/cadastroOng">
