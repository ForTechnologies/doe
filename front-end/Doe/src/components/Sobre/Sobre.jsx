            ...
            <div className="sobrepor">
                <div className="sobre">
                    ...
                    <div className="plataforma">
                        ...
                        <h1 className="online">Plataforma Online Que <br />
                            Une Ongs E Doadores!
                        </h1>
                        ...
                        <span className="campanha">No doe! voce encontra ongs e campanhas mais proximas de <br />
                            sua localização, sem precisar sair pela cidade. com facilidade e <br />
                            acesso!
                        </span>
